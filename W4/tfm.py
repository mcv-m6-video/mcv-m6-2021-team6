...
##SOURCE: https://github.com/fernaper/tfm-artificial-vision
...
class LucasKanade_OF(VideoController):
    ...
    def __init__(self, video, stream, fps, scale=1, separate_frame=None, process_all_frame=False,
                 concatenate_frame=None, **kwargs):
        path_to_video = '../datasets/AICity_data/train/S03/c010/vdo.avi'
        VideoController.__init__(self, path_to_video, stream, fps)
    ...
    def next_frame(self, frame, not_processable_frame, prev_gray_frame, current_points, mask, good_new=[], good_old=[]):
        ...
        next_points, status, _ = cv2.calcOpticalFlowPyrLK(prev_gray_frame, gray_frame, current_points, None,
                                                          **self.lk_params)
