"""
Usage:
  task3.py <Method> <Filters>  [--testDir=<td>]
  task3.py -h | --help

  <Method> --> Method to subtract the background (KKN or MOG2)
  <Filters> --> Bolean to decide if we want to remove the noise or use the original function from openCV
  Example of use --> python task3.py KKN True
"""
